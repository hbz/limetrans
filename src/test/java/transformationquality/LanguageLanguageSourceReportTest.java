...
public class LanguageLanguageSourceReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/Language/languageSource");
    }

    public LanguageLanguageSourceReportTest(String aField) {
        mField = aField;
    }
