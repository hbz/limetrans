...
public class PersonPersonTitleReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/Person/personTitle");
    }

    public PersonPersonTitleReportTest(String aField) {
        mField = aField;
    }
