...
public class PersonContributorPersonNameReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/PersonContributor/0/personName");
    }

    public PersonContributorPersonNameReportTest(String aField) {
        mField = aField;
    }
