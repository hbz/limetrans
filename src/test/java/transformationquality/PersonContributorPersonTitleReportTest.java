...
public class PersonContributorPersonTitleReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/PersonContributor/0/personTitle");
    }

    public PersonContributorPersonTitleReportTest(String aField) {
        mField = aField;
    }
