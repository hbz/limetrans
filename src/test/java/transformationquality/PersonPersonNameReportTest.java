...
public class PersonPersonNameReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/Person/personName");
    }

    public PersonPersonNameReportTest(String aField) {
        mField = aField;
    }
