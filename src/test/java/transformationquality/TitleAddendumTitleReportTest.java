...
public class TitleAddendumTitleReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/TitleAddendum/title");
    }

    public TitleAddendumTitleReportTest(String aField) {
        mField = aField;
    }
