...
public class RSWKSubjectIdentifierReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/RSWK/0/subjectIdentifier");
    }

    public RSWKSubjectIdentifierReportTest(String aField) {
        mField = aField;
    }
