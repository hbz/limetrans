...
public class PublisherNameNameReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/PublisherName/name");
    }

    public PublisherNameNameReportTest(String aField) {
        mField = aField;
    }
