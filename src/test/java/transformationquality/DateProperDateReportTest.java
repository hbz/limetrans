...
public class DateProperDateReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/DateProper/date");
    }

    public DateProperDateReportTest(String aField) {
        mField = aField;
    }
