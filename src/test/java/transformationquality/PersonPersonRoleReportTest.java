...
public class PersonPersonRoleReportTest extends AbstractFieldReportTest{

    final private static Logger mLogger = LogManager.getLogger();

    @Parameterized.Parameters
    public static Collection<Object> data() {
        return Arrays.asList("/Person/personRole/0");
    }

    public PersonPersonRoleReportTest(String aField) {
        mField = aField;
    }
